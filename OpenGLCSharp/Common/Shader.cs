...
namespace OpenGLCSharp.Common {
    ...
    public class Shader : IDisposable {
        ...
        public Shader(string vertPath, string fragPath) {
            ...
            GL.GetProgram( this.Handle, GetProgramParameterName.ActiveUniforms, out int numberOfUniforms );
            ...
            for ( var i = 0; i < numberOfUniforms; i++ ) {
                ...
                string key = GL.GetActiveUniform( this.Handle, i, out _, out _ );

                // get the location,
                int location = GL.GetUniformLocation( this.Handle, key );
        ...
        public int GetAttribLocation(string attribName) { return GL.GetAttribLocation( this.Handle, attribName ); }
        ...
        public void SetVector4(string name, Vector4 data) {
            GL.UseProgram( this.Handle );
            GL.Uniform4( this._uniformLocations[name], data );
        }
        ...
        ~Shader() { Program.ResourceLeak( this.GetType() ); }
